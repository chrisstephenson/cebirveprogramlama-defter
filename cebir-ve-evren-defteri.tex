...
\hazirfonkspec{string=?}{string string }{boolean}{İki string eşit ise doğru, yoksar yanlış}
...
\hazirfonkspec{place-line/v}{v v color imaj }{imaj}{İki vektör arasında olan çizgi verilen color ile sahneye (imaja) yerleştirmek}
