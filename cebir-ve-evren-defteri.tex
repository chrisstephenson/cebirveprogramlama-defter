...
\hazirfonkspec{string-append}{string string }{boolean}{İki string arka arkaya ekliyor}
...
\hazirfonkspec{SES}{herhangi string }{herhangi}{stringde belirtilen .wav dosyasını çaldırıp birinci paramtresi olduğu gibi döndürmek. Genel olarak evren olur, başka veri tipi de olabilir}
\end{tabular}
\newpage
